...
<div class="container">
	<div>
    	<h1 class="h2" align="center">&nbsp; Modify User Information<a class="btn btn-success" href="admin.php" style="margin-left: 850px"><span class="glyphicon glyphicon-home"></span>&nbsp; Back</a></h1><hr>
    </div>
<form id="myform" method="post" enctype="multipart/form-data" class="form-horizontal" style="margin: 0 300px 0 300px;border: solid 1px;border-radius:4px">
    ...
    <tr>
        ...
        <td>
        <input id="id" class="form-control" type="text" name="<? echo $r1; ?>" value="<?php echo $username; ?>" placeholder="Type your ID." autocomplete="off" readonly   />
    ...
    <tr>
        ...
        ?>
        <input id="pw" class="form-control" type="password" name="<? echo $r2; ?>" value="<?php echo $decrypted_password; ?>" placeholder="Type your password." 
    ...
    <tr>
        ...
        <td>
        <input class="form-control" type="text" name="<? echo $r3; ?>" value="<?php echo $userprofile; ?>" placeholder="Type your profile." 
               autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" required />
	...
	<tr>
	<td><label class="control-label">Account activition</label></td>
	<td>
	<?php if($activate)
	{ 
	?>
    ...
    <tr>
		...
		<button type="submit" name="btn_save_updates" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-save"></span>&nbsp; Update</button>
        <a class="btn btn-warning" href="admin.php"> <span class="glyphicon glyphicon-remove"></span>&nbsp; Cancel</a>
        </td>
    </tr>
    </table>
</form>
